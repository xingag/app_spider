...
public class Constants
{
    ...
    //Webview
    public static String class_name_webview_topactivity = "com.taobao.idlefish.webview.WebHybridActivity";
    public static String class_name_webview = "com.taobao.idlefishandroid.webkit.WebView";
