...
class GoodTop(object):
    ...
    def run(self):
        ...
        while (browser_end - browser_start).seconds < self.spider_time:
            ...
            # self.poco.swipe([0.5, 0.8], [0.5, 0.4], duration=1)
    ...
    def __test_swipe(self):
        ...
        # 列表的坐标
        position_lv = element.find_elment_position_by_id_and_index("com.taobao.idlefish:id/list_recyclerview",
                                                                   "0")
        ...
        print('下面是商品元素的坐标')
        print('==' * 60)
        print(position_item[0])
        print(position_item[1])
        print('==' * 60)

        # 商品列表顶部y轴坐标
        first_good_y = position_lv[0][1]
        ...
        exec_cmd('adb shell input swipe %d %d %d %d %d' % (500, 1800, 500, 1800 - 481, 1000))
        sleep(5)

        exec_cmd('adb shell input swipe %d %d %d %d %d' % (500, 1600, 500, 1000 + 48, 1000))
